...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository, TransactionRepository transactionRepository, LoanRepository loanRepository, ClientLoanRepository clientLoanRepository, CardRepository cardRepository) {
		return (args) -> {
			...
			Account account1 = new Account("VIN001", 5000.0, LocalDateTime.now(),client1,true,AccountType.CURRENT);
			Account account2 = new Account("VIN002", 7500.0, LocalDateTime.now().plusDays(1),client1,true,AccountType.CURRENT);
			...
			Card card1 = new Card(client1,(client1.getFirstName() + " " + client1.getLastName()),CardType.DEBIT, CardColor.GOLD,"5030-3695-5876-6231",982,LocalDateTime.now(),LocalDateTime.now().plusYears(5),true);
			Card card2 = new Card(client1,(client1.getFirstName() + " " + client1.getLastName()),CardType.CREDIT, CardColor.TITANIUM,"3103-5785-7892-4537",582,LocalDateTime.now(),LocalDateTime.now(),true);
			Card card3 = new Card(client2,(client2.getFirstName() + " " + client2.getLastName()),CardType.DEBIT, CardColor.SILVER,"4566-7869-4532-2305",369,LocalDateTime.now(),LocalDateTime.now().plusYears(5),true);
